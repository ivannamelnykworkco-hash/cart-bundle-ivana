...
export function BoxUpSellItem({
  ...
  useEffect(() => {
    ...
    const basePrice = safeBasePerUnit * safeQuantity || 0;
    // 4. Calculate final price based on selectPrice
    ...
    if (selectPrice === "discounted%") {
      ...
      calculated = safeValue; // specific overrides total price directly
    }

    // 5. Ensure non-negative and finite
    if (!Number.isFinite(calculated) || calculated < 0) {
      calculated = 0;
    }

    // 6. Send updated data to parent
