/*
  ...
  - Added the required column `swatchOption` to the `GeneralSetting` table without a default value. This is not possible if the table is not empty.
  - Added the required column `swatchType` to the `GeneralSetting` table without a default value. This is not possible if the table is not empty.
