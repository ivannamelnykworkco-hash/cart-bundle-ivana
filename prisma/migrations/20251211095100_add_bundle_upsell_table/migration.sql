/*
  ...
  - You are about to drop the column `labelSize` on the `UpsellItem` table. All the data in the column will be lost.
...
CREATE TABLE "new_UpsellItem" (
    ...
    "imageSize" INTEGER NOT NULL DEFAULT 20,
...
INSERT INTO "new_UpsellItem" ("bgColor", "buId", "bxGyId", "createdAt", "discountPrice", "id", "isSelectedByDefault", "isSelectedProduct", "isShowAsSoldOut", "isVisibleOnly", "labelTitle", "opacity", "priceText", "qbId", "selectPrice", "selectedVariants", "textColor", "updatedAt") SELECT "bgColor", "buId", "bxGyId", "createdAt", "discountPrice", "id", "isSelectedByDefault", "isSelectedProduct", "isShowAsSoldOut", "isVisibleOnly", "labelTitle", "opacity", "priceText", "qbId", "selectPrice", "selectedVariants", "textColor", "updatedAt" FROM "UpsellItem";
