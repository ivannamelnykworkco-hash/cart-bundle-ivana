/*
  ...
  - Added the required column `buId` to the `BundleUpsellItem` table without a default value. This is not possible if the table is not empty.
  - Added the required column `bxGyId` to the `BxGyUpsellItem` table without a default value. This is not possible if the table is not empty.
  - Added the required column `qbId` to the `QbUpsellItem` table without a default value. This is not possible if the table is not empty.
