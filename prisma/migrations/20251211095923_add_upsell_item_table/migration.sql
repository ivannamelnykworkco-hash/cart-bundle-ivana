...
CREATE TABLE "new_UpsellItem" (
    ...
    "labelSize" INTEGER NOT NULL DEFAULT 15,
...
INSERT INTO "new_UpsellItem" ("bgColor", "buId", "bxGyId", "createdAt", "discountPrice", "id", "imageSize", "isSelectedByDefault", "isSelectedProduct", "isShowAsSoldOut", "isVisibleOnly", "labelTitle", "opacity", "priceText", "qbId", "quantity", "selectPrice", "selectedVariants", "textColor", "updatedAt") SELECT "bgColor", "buId", "bxGyId", "createdAt", "discountPrice", "id", "imageSize", "isSelectedByDefault", "isSelectedProduct", "isShowAsSoldOut", "isVisibleOnly", "labelTitle", "opacity", "priceText", "qbId", "quantity", "selectPrice", "selectedVariants", "textColor", "updatedAt" FROM "UpsellItem";
