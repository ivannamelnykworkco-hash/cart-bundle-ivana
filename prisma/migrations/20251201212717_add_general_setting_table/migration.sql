/*
  ...
  - Added the required column `priceSelect` to the `GeneralSetting` table without a default value. This is not possible if the table is not empty.
  - Added the required column `showPriceRounding` to the `GeneralSetting` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_GeneralSetting" ("blockTitle", "bundleId", "bundleName", "colorSwatchArray", "createdAt", "discountName", "endDateTime", "excludeB2B", "excludePOS", "excludedCollections", "excludedProducts", "hideTheme", "id", "imageSwatchArray", "letCustomer", "markets", "msgColor", "msgText", "priceRounding", "selectedCollections", "selectedProducts", "setDefaultVariant", "setEndDate", "showBothPrices", "showPrices", "showPricesWithout", "showVariant", "showWhenStock", "skipCart", "startDateTime", "swatchOption", "swatchShape", "swatchSize", "swatchType", "unitLabel", "updateTheme", "updatedAt", "useProductCompare", "visibility") SELECT "blockTitle", "bundleId", "bundleName", "colorSwatchArray", "createdAt", "discountName", "endDateTime", "excludeB2B", "excludePOS", "excludedCollections", "excludedProducts", "hideTheme", "id", "imageSwatchArray", "letCustomer", "markets", "msgColor", "msgText", "priceRounding", "selectedCollections", "selectedProducts", "setDefaultVariant", "setEndDate", "showBothPrices", "showPrices", "showPricesWithout", "showVariant", "showWhenStock", "skipCart", "startDateTime", "swatchOption", "swatchShape", "swatchSize", "swatchType", "unitLabel", "updateTheme", "updatedAt", "useProductCompare", "visibility" FROM "GeneralSetting";
