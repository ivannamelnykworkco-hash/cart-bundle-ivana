/*
  ...
  - You are about to alter the column `updateTheme` on the `GeneralSetting` table. The data in that column could be lost. The data in that column will be cast from `String` to `Boolean`.
  - Added the required column `showAlert` to the `GeneralSetting` table without a default value. This is not possible if the table is not empty.
